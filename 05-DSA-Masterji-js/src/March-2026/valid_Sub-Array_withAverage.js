 ...
 */
class vaildSubArray {
    countVaildSubarray(arr, k, threshold) {
        let len = arr.length;
        let count = 0;
        // let sum = 0;
        for (let i = 0; i < len; i++) {
            ...
            let sum = subarr.reduce((acc, curr) => {
                return acc + curr;
            }, 0);
...
console.log(vaild.countVaildSubarray([1000000, 1000000, 1000000, 1000000, 1000000], 1, 1000000));
/*
    0 ------ 3,3,3
1 ------ 3,3,3
2 ------ 3,3,6
