...
export function biryaniBatchProcessor(orders) {
  ...
  do{
    ...
    do{
      ...
      let plateinBatch = remaining > 5 ? 5 : remaining;

      ordersDetails.totalBatches++;
      ordersDetails.totalPlates += plateinBatch;

      remaining -= plateinBatch;

    }while(remaining > 0);

    ordersDetails.ordersProcessed++;
