...
export function chaiTapriRevenue(customers) {
  ...
  const order_summary = {totalChai: 0, totalRevenue: 0};
  ...
  const grandTotal = (cuttingChai*10) + (adrakChai*15);


  order_summary.totalChai = customers;
  order_summary.totalRevenue = grandTotal;
