...
export function diwaliLightsPlan(lightStrings, budget) {
  ...
  // step1: add all lights
  for(let light of lightStrings){
  
    let rate = Object.hasOwn(color_rateCard, light.color)
                ? color_rateCard[light.color]
                : color_rateCard["other"];

    let cost = rate * light.length ;
